...
namespace Course
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Teacher teacher5 = new(){Username = "hemid021", Firstname = "hemid", Lastname = "eliyev",Departmentname = "it", Subject = "ia",Birthdate = new DateOnly(2005, 05, 14),Address = "baku",Phonenumber = "0556717530",Email = "hamidaali@gameil.com", Password ="12345678" };
            Teacher teacher6 = new(){Username = "seid123", Firstname = "seid", Lastname = "oxranov",Departmentname = "it", Subject = "front",Birthdate = new DateOnly(1990, 05, 14),Address = "baku",Phonenumber = "0556717530",Email = "hamidaali@gameil.com", Password ="12345678" };
            Teacher teacher7 = new(){Username = "kamran345", Firstname = "karan", Lastname = "teymurov",Departmentname = "it", Subject = "front",Birthdate = new DateOnly(2000, 05, 14),Address = "baku",Phonenumber = "0556717530",Email = "hamidaali@gameil.com", Password ="12345678" };
